...
# Prefer an existing packaged TBB (e.g. from vcpkg) to avoid building a second copy
find_package(TBB CONFIG QUIET)
if(TARGET TBB::tbb)
    message(STATUS "Third-party: using pre-installed target 'TBB::tbb' (find_package)")
    return()
endif()
